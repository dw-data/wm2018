...
Based on group stage results (points and rank) and all following games (1 point for winning, 0 for loosing)

Idea: Peter Wozny

Data Analysis: Eva Lopez & Gianna-Carina Grün

Reporting: David Vorholt, Eva Lopez
...
d = Success parameter
	...
	--> average of the two
	- 1 for winning during knock out phase, 0 for loosing during knock out phase
...
See [this Google Spreadsheet](https://docs.google.com/spreadsheets/d/1v8MYzDt7YSrJshmYGTeGajN2TNPR_l5aKSA-0uTVf3I/edit#gid=1265674444) compiling all data, documenting calculation steps and for the final score for 2018. [Here](https://docs.google.com/spreadsheets/d/1WlHbR9yEpG0FdC25jVhXChNB2XwxODd-Dz7_-xxbFwo/edit?usp=sharing) you find all these details for the 2014 analysis.

![](57-EN-DW-Score-2018-all-matches-01.png)

#### DW Score List

![](59-EN-DW-Score-Table-all-matches-associations-01.png)
![](58-EN-DW-Score-Table-all-matches-01.png)
